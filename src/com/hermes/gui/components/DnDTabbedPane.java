package com.hermes.gui.components;
...
public class DnDTabbedPane extends JTabbedPane {
    ...
    private final Color m_lineColor = new Color(95,95,95);
    ...
    public DnDTabbedPane() {
        ...
        final DragGestureListener dgl = new DragGestureListener() {
            public void dragGestureRecognized(DragGestureEvent e) {
                ...
                if (dragTabIndex < 1 || dragTabIndex==getTabCount()-1 ) {
                    return;
                } // if
    ...
    @Override
    public void add(final Component component, Object constraints, int index) {
        ...
        closeButton.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseClicked(MouseEvent e)
            {
                ...
                remove(component);
                ((com.hermes.gui.Panel) component).close();
        ...
        closeButton.addActionListener(action);
         ...
         int newIndex = indexOfComponent(component);
       setTabComponentAt(newIndex, getTitlePanel(constraints.toString(), new javax.swing.ImageIcon(getClass().getResource("/com/hermes/resources/images/chat.png")), closeButton, 6));
    }

    @Override
    public void addTab(String title, Component component) {
        add(component,title,getTabCount()-1);
    }

    
    
    
    private JPanel getTitlePanel(String title, ImageIcon icon, JButton button, int margin)
    {
    ...
    class CDropTargetListener implements DropTargetListener {
        ...
        public boolean isDropAcceptable(DropTargetDropEvent e) {
            ...
            int drop_index=getTargetTabIndex(e.getLocation());
            
            if(drop_index<1 || drop_index>=getTabCount())
            {
                return false;
            }
    ...
    public void insertTab(String title, Icon icon, final Component component, String tip, int index) {
        ...
        closeButton.addActionListener(action);
         ...
         int newIndex = indexOfComponent(component);
       setTabComponentAt(newIndex, getTitlePanel(title, new javax.swing.ImageIcon(getClass().getResource("/com/hermes/resources/images/chat.png")), closeButton, 6));
    }
